              ...
              >
                <div className="grid gap-10 lg:grid-cols-[0.65fr_1.35fr]">
                  ...
                  <div className="grid gap-8 sm:grid-cols-2">
                    <div>
                      <p className="text-[11px] font-bold uppercase text-burgundy">
                        Что входит
                      </p>
                      <ul className="mt-4 grid gap-3">
                        {service.includes.map((item) => (
                          <li key={item} className="flex gap-3 text-sm font-medium leading-6 text-main/80">
                    ...
                    <div className="border-t border-main/15 pt-5 sm:border-l sm:border-t-0 sm:pl-7 sm:pt-0">
                      ...
                      <p className="mt-4 text-sm font-medium leading-7 text-main/80">
                        {service.clientReceives}
                      </p>
                      <p className="mt-6 text-[11px] font-bold uppercase text-burgundy">
                        Срок
                      </p>
                      <p className="mt-3 text-sm font-medium leading-7 text-main/80">{service.timing}</p>
                      {service.caseHref && service.caseLabel ? (
                        <Link
                          href={service.caseHref}
                          className="focus-ring group mt-6 inline-flex items-center gap-2 text-sm font-bold text-burgundy transition hover:text-main"
                        >
                ...
                <TrackedLink
                  ...
                  className="focus-ring mt-9 inline-flex min-h-12 items-center justify-center border border-burgundy bg-burgundy px-5 text-sm font-bold text-paper shadow-press transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-[1.01] hover:shadow-2xl"
                >
                  Обсудить задачу
                </TrackedLink>
              </article>
      ...
      <section className="bg-paper py-20 text-main sm:py-28">
        <div className="section-shell">
          <div className="max-w-3xl">
            ...
            <h2 className="text-balance mt-5 font-heading text-3xl font-bold leading-[1.04] sm:text-5xl">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {presentationPackages.map((item) => (
              ...
              >
                ...
                <ul className="mt-6 grid gap-3 border-t border-main/15 pt-6">
                ...
                <div className="mt-auto pt-8">
                  ...
                  <p className="mt-2 text-sm leading-6 text-main/70">{item.price}</p>
                </div>
              </article>
            ))}
          </div>
